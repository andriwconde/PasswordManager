...
return(<Drawer.Navigator>
  <Drawer.Screen name="Home" component={StartScreen} options={{headerShown:false, drawerPosition:'right'}}/>
  <Drawer.Screen name="Settings" component={SettingsScreen} options={{headerShown:false, drawerPosition:'right'}}/>
</Drawer.Navigator>)
}
  ...
  return (
    <Provider store={store}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Login">
          <Stack.Screen name="Login" component={LoginScreen} options={{headerShown:false}}/>
          <Stack.Screen name="Start" component={DrawerNavigator} options={{headerShown:false}}/>
          <Stack.Screen name="Register" component={RegisterScreen} options={{headerShown:false}}/>
          <Stack.Screen name="AccountCrud" component={AccountCrud} options={{headerShown:false}}/>
          <Stack.Screen name="BiometricEnrollment" component={BiometricEnrollmentScreen} options={{headerShown:false}}/>
        </Stack.Navigator>
